...
function landingServiceItemComponent(drivers) {
  ...
  var vtree$ = props$.map(function (serviceType) {
    ...
    return (0, _cycleDom.h)('a', { href: '/map' }, [(0, _cycleDom.h)('img', { "src": serviceType.imageURL }), (0, _cycleDom.h)('a.container', { href: '/map' }, [(0, _cycleDom.h)('h2', serviceType.name), (0, _cycleDom.h)('p', serviceType.description)])]);
  });
