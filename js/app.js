...
},{"min-document":119}],86:[function(require,module,exports){
"use strict";
...
},{"@cycle/core":1,"superagent":116}],115:[function(require,module,exports){
"use strict";
...
},{"./http-driver":114}],116:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
function cityItemComponent(drivers) {
  ...
  var vtree$ = props$.map(function (_ref) {
    ...
    return (0, _cycleDom.h)('li.list-group-item', [(0, _cycleDom.h)('img.slot-img', { "src": "http://www.noroadsentertainment.com/wp-content/uploads/2015/03/helsinki-finland.jpg" }), (0, _cycleDom.h)('h2', city.city)]);
  });
...
},{"@cycle/core":1,"@cycle/dom":5}],124:[function(require,module,exports){
'use strict';
...
function serviceItemComponent(drivers) {
  ...
  var vtree$ = props$.map(function (_ref) {
    ...
    return (0, _cycleDom.h)('li.list-group-item.container', [(0, _cycleDom.h)('div.col-sm-9', [(0, _cycleDom.h)('h2', service.name), (0, _cycleDom.h)('h3', service.count + " palveluntarjoajaa alueella"), (0, _cycleDom.h)('div', service.description)])]);
  });
...
function todoItemComponent(drivers) {
  ...
  var vtree$ = _cycleCore.Rx.Observable.combineLatest(props$, editing$, function (_ref, editing) {
    ...
    return (0, _cycleDom.h)('li.list-group-item' + classes, [(0, _cycleDom.h)('div', [
    /*
    h('input.toggle', {
      type: 'checkbox',
      checked: propHook(elem => elem.checked = completed)
    }),*/
    (0, _cycleDom.h)('h3', content), (0, _cycleDom.h)('div', times)
    //h('button.destroy')
    ])
    /*
    h('input.edit', {
